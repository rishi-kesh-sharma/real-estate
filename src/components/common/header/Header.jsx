...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {!show && (
        <FiMenu
          className=" text-black text-bold mr-[1.5rem] right-[3rem] text-4xl font-extralight lg:hidden"
      ...
      {show && (currentDevice == "sm" || currentDevice == "md") && (
        <div className="  text-red-600 fixed left-0 z-40  right-0 top-0 h-[100vh]   lg:hidden  ">
          <aside
          ...
          >
            {show && (
              <RxCross1
                className="absolute text-black top-[1rem] text-3xl  left-[0.5rem] z-50 lg:hidden"
